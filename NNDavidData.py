...
# %% need to write a function returning f1dot (the derivative of the ReLU)
...
#xtest = np.matmul(W1.T, X[0:1].T) + B1

#sigdertest = sigder(xtest, 32)
...
# =============================================================================
# def gradfunc2(x, size ):
#     
#     # transform from the power vector to W*x + bias
#     #x = np.matmul(W1.T, x.T) + B1
#     
#     grad = np.matmul(ReLUder(x, size),  W1) 
# 
#     grad = np.matmul(W2.T, grad.T)
#     
#     return grad
# =============================================================================
